...
## Layer 2: Organization (Pakalon / Codex)

Use Pakalon or Codex to:
...
Use Pakalon to analyze transcript + scene timestamps:
```
...
|------|----------|----------|
| Pakalon / Codex | Organization, planning, code generation | Not the creative taste layer |
