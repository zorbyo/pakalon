...
```yaml
# [OK] CORRECT: Minimal permissions
iam_role:
  permissions:
...
# [X] WRONG: Overly broad permissions
iam_role:
  permissions:
    - s3:*  # All S3 actions
  resources:
...
```typescript
// [OK] CORRECT: Use cloud secrets manager
...
// [X] WRONG: Hardcoded or in environment variables only
...
```terraform
# [OK] CORRECT: Restricted security group
...
```typescript
// [OK] CORRECT: Comprehensive logging
...
```yaml
# [OK] CORRECT: Secure GitHub Actions workflow
name: Deploy
...
```typescript
// [OK] CORRECT: Cloudflare Workers with security headers
export default {
...
```terraform
# [OK] CORRECT: Automated RDS backups
...
```bash
# [X] WRONG: Public bucket
aws s3api put-bucket-acl --bucket my-bucket --acl public-read

# [OK] CORRECT: Private bucket with specific access
