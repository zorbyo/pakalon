export const dict = {
  ...
  "desktop.menu.help.documentation": "Pakalon Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Pakalon CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
