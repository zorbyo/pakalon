  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Pakalon sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Pakalon session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Pakalon session for interacting with AI assistants and managing conversations.",
