...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/pakalon.git")).toEqual({ owner: "sst", repo: "pakalon" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/pakalon")).toEqual({ owner: "sst", repo: "pakalon" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/pakalon.git")).toEqual({ owner: "sst", repo: "pakalon" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/pakalon")).toEqual({ owner: "sst", repo: "pakalon" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/pakalon.git")).toEqual({ owner: "sst", repo: "pakalon" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/pakalon")).toEqual({ owner: "sst", repo: "pakalon" })
})
