export const dict = {
  ...
  "dialog.provider.pakalon.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.pakalon.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.pakalonGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Pakalon",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Pakalon.",
  ...
  "provider.connect.pakalonZen.line1":
    "Pakalon Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.pakalonZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.pakalonZen.visit.prefix": "Besøg ",
  "provider.connect.pakalonZen.visit.link": "pakalon.ai/zen",
  "provider.connect.pakalonZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Pakalon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Pakalon.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i pakalon.json",
  ...
  "dialog.server.description": "Skift hvilken Pakalon-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Pakalon ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Pakalon-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (pakalon.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Pakalon understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Pakalon inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Pakalon-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Pakalon",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Pakalon ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Pakalon følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Pakalon er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Pakalon starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Pakalon.",
