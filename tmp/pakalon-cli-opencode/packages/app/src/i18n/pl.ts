export const dict = {
  ...
  "dialog.provider.pakalon.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.pakalon.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.pakalonGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Pakalon",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Pakalon.",
  ...
  "provider.connect.pakalonZen.line1":
    "Pakalon Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.pakalonZen.visit.prefix": "Odwiedź ",
  "provider.connect.pakalonZen.visit.link": "pakalon.ai/zen",
  "provider.connect.pakalonZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Pakalon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Pakalon.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w pakalon.json",
  ...
  "dialog.server.description": "Przełącz serwer Pakalon, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Pakalon ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Pakalon",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (pakalon.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Pakalon zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Pakalon",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Pakalon na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Pakalon ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Pakalon.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Pakalon",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Pakalon.",
