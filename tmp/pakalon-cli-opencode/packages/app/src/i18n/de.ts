...
export const dict = {
  ...
  "dialog.provider.pakalon.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.pakalon.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.pakalonGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Pakalon",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Pakalon zu nutzen.",
  ...
  "provider.connect.pakalonZen.line1":
    "Pakalon Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.pakalonZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.pakalonZen.visit.link": "pakalon.ai/zen",
  "provider.connect.pakalonZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Pakalon zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Pakalon zu nutzen.",
  ...
  "dialog.plugins.empty": "In pakalon.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Pakalon-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Pakalon ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Pakalon-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (pakalon.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Pakalon unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Pakalon enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Pakalon-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Pakalon ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Pakalon auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Pakalon dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Pakalon anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Pakalon automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Pakalon.",
