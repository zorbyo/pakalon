export const dict = {
  ...
  "dialog.provider.pakalon.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.pakalon.tagline": "Modèles optimisés et fiables",
  "dialog.provider.pakalonGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Pakalon",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Pakalon.",
  ...
  "provider.connect.pakalonZen.line1":
    "Pakalon Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.pakalonZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.pakalonZen.visit.prefix": "Visitez ",
  "provider.connect.pakalonZen.visit.link": "pakalon.ai/zen",
  "provider.connect.pakalonZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Pakalon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Pakalon.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans pakalon.json",
  ...
  "dialog.server.description": "Changez le serveur Pakalon auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Pakalon ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Pakalon",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (pakalon.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Pakalon ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Pakalon inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "Pakalon Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Pakalon dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Pakalon",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Pakalon sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Pakalon suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Pakalon.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Pakalon",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Pakalon.",
