export const dict = {
  ...
  "dialog.provider.pakalon.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.pakalon.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.pakalonGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Pakalon",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Pakalon-u.",
  ...
  "provider.connect.pakalonZen.line1":
    "Pakalon Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.pakalonZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.pakalonZen.visit.prefix": "Posjeti ",
  "provider.connect.pakalonZen.visit.link": "pakalon.ai/zen",
  "provider.connect.pakalonZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Pakalon-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Pakalon-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u pakalon.json",
  ...
  "dialog.server.description": "Promijeni na koji se Pakalon server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Pakalon-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Pakalon timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (pakalon.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Pakalon još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Pakalon uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Pakalon server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Pakalon-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Pakalon izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Pakalon prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Pakalon-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Pakalon pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Pakalon-a.",
