...
export const dict = {
  ...
  "dialog.provider.pakalon.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.pakalon.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.pakalonGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Pakalon",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Pakalon.",
  ...
  "provider.connect.pakalonZen.line1":
    "Pakalon Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.pakalonZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.pakalonZen.visit.prefix": "Besøk ",
  "provider.connect.pakalonZen.visit.link": "pakalon.ai/zen",
  "provider.connect.pakalonZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Pakalon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Pakalon.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i pakalon.json",
  ...
  "dialog.server.description": "Bytt hvilken Pakalon-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Pakalon ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Pakalon-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (pakalon.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Pakalon ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Pakalon inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Pakalon-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Pakalon",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Pakalon ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Pakalon skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Pakalon er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Pakalon starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Pakalon.",
