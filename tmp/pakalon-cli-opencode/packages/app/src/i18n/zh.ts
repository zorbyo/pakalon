...
export const dict = {
  ...
  "dialog.provider.pakalon.note": "使用 Pakalon Zen 或 API 密钥连接",
  "dialog.provider.pakalon.tagline": "可靠的优化模型",
  "dialog.provider.pakalonGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Pakalon 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Pakalon 中使用 {{provider}} 模型。",
  ...
  "provider.connect.pakalonZen.line1": "Pakalon Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.pakalonZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.pakalonZen.visit.prefix": "访问 ",
  "provider.connect.pakalonZen.visit.link": "pakalon.ai/zen",
  "provider.connect.pakalonZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Pakalon 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Pakalon 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 pakalon.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Pakalon 服务器。",
  ...
  "toast.update.description": "Pakalon 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Pakalon 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (pakalon.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Pakalon 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Pakalon 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Pakalon 服务器。",
  ...
  "settings.general.row.language.description": "更改 Pakalon 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Pakalon 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Pakalon 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Pakalon 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Pakalon 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Pakalon。",
