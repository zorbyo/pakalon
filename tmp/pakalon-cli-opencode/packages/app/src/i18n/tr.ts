...
export const dict = {
  ...
  "dialog.provider.pakalon.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.pakalon.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.pakalonGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Pakalon tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Pakalon'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.pakalonZen.line1":
    "Pakalon Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.pakalonZen.visit.prefix": "",
  "provider.connect.pakalonZen.visit.link": "pakalon.ai/zen",
  "provider.connect.pakalonZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Pakalon'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Pakalon'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler pakalon.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Pakalon sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Pakalon'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Pakalon ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (pakalon.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Pakalon henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Pakalon ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Pakalon Masaüstü",
  ...
  "settings.desktop.wsl.description": "Pakalon sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Pakalon'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Pakalon'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Pakalon'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Pakalon'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Pakalon başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Pakalon'un en son sürümünü kullanıyorsunuz.",
