...
import { Session, type Message } from "@pakalon-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@pakalon-ai/ui/toast"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://pakalon.ai/desktop-feedback")}
      renderPanel={() =>
        mobile ? (
