...
import { cycleModelVariant, filterSupportedModelVariants, getConfiguredAgentVariant, resolveModelVariant } from "./model-variant"
    ...
    const model = {
      ...
      variant: {
        ...
        list() {
          ...
          return filterSupportedModelVariants({
