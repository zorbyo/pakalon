...
beforeAll(async () => {
  ...
  mock.module("@pakalon-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@pakalon-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@pakalon-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@pakalon-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
