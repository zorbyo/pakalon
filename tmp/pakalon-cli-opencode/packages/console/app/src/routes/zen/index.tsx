...
import compareVideo from "../../asset/lander/pakalon-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/pakalon-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="pakalon:auth" content={loggedin() ? "true" : "false"} />
