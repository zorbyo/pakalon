...
import desktopAppIcon from "../../asset/lander/pakalon-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://pakalon.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>pakalon.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g pakalon-ai")}>
                <code>
                  npm i -g <strong>pakalon-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g pakalon-ai")}>
                <code>
                  bun add -g <strong>pakalon-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/pakalon")}>
                <code>
                  brew install <strong>anomalyco/tap/pakalon</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S pakalon")}>
                <code>
                  paru -S <strong>pakalon</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask pakalon-desktop")}>
                <code>
                  brew install --cask <strong>pakalon-desktop</strong>
                </code>
                <CopyStatus />
              </button>
