...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Pakalon | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Pakalon terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Pakalon. Please read on to learn the rules and restrictions that govern your use of
                Pakalon&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Pakalon," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://pakalon.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-pakalon">What is Pakalon?</h2>
              <p>
                Pakalon is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Pakalon Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Pakalon enables you to
              ...
              <p>
                ...
                our site located at pakalon.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Pakalon takes the privacy of its users very seriously. For the current Pakalon Privacy Policy, please
                click here{" "}
                <a href="https://pakalon.ai/legal/privacy-policy">https://pakalon.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Pakalon?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Pakalon;
                </li>
                <li>
              ...
              <p>
                If you use Pakalon with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Pakalon. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Pakalon has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-pakalon-ever-change-the-services">Will Pakalon ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://pakalon.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://pakalon.ai/auth">https://pakalon.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://pakalon.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Pakalon is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Pakalon has the sole right to decide whether you are
              ...
              <p>
                Pakalon and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Pakalon and all such
                parties together, the "Pakalon Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Pakalon Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Pakalon Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY PAKALON (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                PAKALON PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO PAKALON IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Pakalon Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Pakalon's prior written
              ...
              <p>
                ...
                disputes and claims with Pakalon and limits the manner in which you can seek relief from Pakalon. Both
                you and Pakalon acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Pakalon's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Pakalon will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Pakalon will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Pakalon may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND PAKALON WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Pakalon are instead choosing to have claims and disputes resolved by
                ...
                you and Pakalon over whether to vacate or enforce an arbitration award, YOU AND PAKALON WAIVE ALL
              ...
              <p>
                ...
                Pakalon is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Pakalon to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Pakalon agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Pakalon may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Pakalon agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Pakalon, and
                ...
                are not an employee, agent, partner, or joint venture of Pakalon, and you do not have any authority of
                any kind to bind Pakalon in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Pakalon
