...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>Pakalon | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="Pakalon privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Pakalon, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Pakalon is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://pakalon.ai/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Pakalon website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Pakalon.
                </li>
              ...
              <p>
                ...
                you, Pakalon or another party; enforcing any agreements with you; responding to claims that any posting
