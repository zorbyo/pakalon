...
/**
 * Server configuration for pakalon serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: pakalon.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://pakalon.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://pakalon.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
