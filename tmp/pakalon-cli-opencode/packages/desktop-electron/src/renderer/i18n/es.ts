export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Pakalon",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Pakalon. ¿Quieres instalarla y reiniciar?",
