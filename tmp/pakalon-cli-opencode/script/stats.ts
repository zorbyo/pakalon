...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/pakalon/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/pakalon...\n")
...
console.log("Fetching npm all-time downloads for pakalon-ai...\n")
const npmDownloads = await fetchNpmDownloads("pakalon-ai")
