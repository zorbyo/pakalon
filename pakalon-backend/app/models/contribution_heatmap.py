"""ContributionHeatmap ORM model — tracks daily contribution data for GitHub-style heatmap."""
import uuid
...
class ContributionHeatmap(Base):
    """Tracks daily contribution data for user activity visualization."""
    ...
    def __repr__(self) -> str:
        return (
            f"<ContributionHeatmap user_id={self.user_id!r}"
            f" date={self.contribution_date!r} lines_added={self.lines_added!r}>"
        )
