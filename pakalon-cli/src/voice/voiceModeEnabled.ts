...
import { isTranscriptionAvailable } from './transcription.js'
...
export function isVoiceModeEnabled(): boolean {
  return hasVoiceAuth() && isVoiceGrowthBookEnabled() && isTranscriptionAvailable()
}

/**
 * Enable or disable voice mode at runtime (used by the /voice command).
 */
