...
// Handle external input changes in useEffect to avoid render-time side effects
// This prevents flickering caused by setCursorOffset during render
useEffect(() => {
  // Input changed externally - this is a significant change like paste or STT injection
  // Move cursor to end for external changes only
...
// This ensures the useEffect above doesn't incorrectly move cursor when user types
