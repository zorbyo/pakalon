...
export function SuccessStep(t0) {
  ...
  let t3;
  if ($[1] !== skipWorkflow) {
    t3 = !skipWorkflow && <Text color="success">[OK] GitHub Actions workflow created!</Text>;
    $[1] = skipWorkflow;
    $[2] = t3;
  } else {
    t3 = $[2];
  ...
  if ($[3] !== secretExists || $[4] !== useExistingSecret) {
    t4 = secretExists && useExistingSecret && <Box marginTop={1}><Text color="success">[OK] Using existing ANTHROPIC_API_KEY secret</Text></Box>;
    $[3] = secretExists;
    $[4] = useExistingSecret;
    $[5] = t4;
  } else {
  ...
  if ($[6] !== secretExists || $[7] !== secretName || $[8] !== useExistingSecret) {
    t5 = (!secretExists || !useExistingSecret) && <Box marginTop={1}><Text color="success">[OK] API key saved as {secretName} secret</Text></Box>;
    $[6] = secretExists;
    $[7] = secretName;
    $[8] = useExistingSecret;
    $[9] = t5;
