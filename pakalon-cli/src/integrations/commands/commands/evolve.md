...
```bash
python3 "${Pakalon_PLUGIN_ROOT}/skills/continuous-learning-v2/scripts/instinct-cli.py" evolve [--generate]
```

Or if `Pakalon_PLUGIN_ROOT` is not set (manual installation):

```bash
python3 ~/.Pakalon/skills/continuous-learning-v2/scripts/instinct-cli.py evolve [--generate]
```
...
6. If `--generate` is passed, write files to:
   - Project scope: `~/.Pakalon/homunculus/projects/<project-id>/evolved/`
   - Global fallback: `~/.Pakalon/homunculus/evolved/`
