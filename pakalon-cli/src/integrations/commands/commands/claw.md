---
description: Start NanoClaw v2 — Pakalon's persistent, zero-dependency REPL with model routing, skill hot-load, branching, compaction, export, and metrics.
---
...
- Sessions are stored at `~/.Pakalon/claw/<session>.md`.
