...
4. Generate command files in `.Pakalon/commands/`
5. Generate script files in `.Pakalon/scripts/`
6. **Update project Pakalon.md** with PM2 info (see below)
7. **Display completion summary** with terminal commands

---

## Post-Init: Update Pakalon.md

After generating files, append PM2 section to project's `Pakalon.md` (create if not exists):
...
**Pakalon Commands:** /pm2-all, /pm2-all-stop, /pm2-{port}, /pm2-{port}-stop, /pm2-logs, /pm2-status
