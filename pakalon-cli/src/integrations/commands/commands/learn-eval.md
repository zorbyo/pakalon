...
3. **Determine save location:**
   ...
   - **Global** (`~/.Pakalon/skills/learned/`): Generic patterns usable across 2+ projects (bash compatibility, LLM API behavior, debugging techniques, etc.)
   - **Project** (`.Pakalon/skills/learned/` in current project): Project-specific knowledge (quirks of a particular config file, project-specific architecture decisions, etc.)
...
5. **Quality gate — Checklist + Holistic verdict**
   ...
   - [ ] Grep `~/.Pakalon/skills/` and relevant project `.Pakalon/skills/` files by keyword to check for content overlap
