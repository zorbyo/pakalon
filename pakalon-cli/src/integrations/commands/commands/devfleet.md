---
description: Orchestrate parallel Pakalon agents via Pakalon DevFleet — plan projects from natural language, dispatch agents in isolated worktrees, monitor progress, and read structured reports.
---

# DevFleet — Multi-Agent Orchestration

Orchestrate parallel Pakalon agents via Pakalon DevFleet. Each agent runs in an isolated git worktree with full tooling.

Requires the DevFleet MCP server: `Pakalon mcp add devfleet --transport http http://localhost:18801/mcp`
