...
[OK] clang-tidy: 2 warnings
[OK] cppcheck: No issues
...
Recommendation: [X] Block merge until CRITICAL issue is fixed
```
...
| Status | Condition |
|--------|-----------|
| [OK] Approve | No CRITICAL or HIGH issues |
| [!] Warning | Only MEDIUM issues (merge with caution) |
| [X] Block | CRITICAL or HIGH issues found |
