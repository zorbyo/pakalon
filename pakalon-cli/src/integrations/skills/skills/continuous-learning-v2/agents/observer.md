...
A background agent that analyzes observations from Pakalon sessions to detect patterns and create instincts.
...
- Project: `~/.Pakalon/homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.Pakalon/homunculus/observations.jsonl`
...
### 1. User Corrections
When a user's follow-up message corrects Pakalon's previous action:
...
- Project: `~/.Pakalon/homunculus/projects/<project-hash>/instincts/personal/`
- Global: `~/.Pakalon/homunculus/instincts/personal/` (for universal patterns)
