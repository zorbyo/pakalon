...
HOMUNCULUS_DIR = Path.home() / ".Pakalon" / "homunculus"
...
def detect_project() -> dict:
    ...
    # 1. Pakalon_PROJECT_DIR env var
    env_dir = os.environ.get("Pakalon_PROJECT_DIR")
...
def cmd_projects(args) -> int:
    ...
    if not registry:
        ...
        print("Projects are auto-detected when you use Pakalon in a git repo.")
        return 0
