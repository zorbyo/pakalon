...
```sql
-- [OK] GOOD: Use indexed columns first
SELECT *
...
-- [X] BAD: Filter on non-indexed columns first
SELECT *
FROM markets_analytics
WHERE volume > 1000
...
```sql
-- [OK] GOOD: Use ClickHouse-specific aggregation functions
SELECT
...
-- [OK] Use quantile for percentiles (more efficient than percentile)
SELECT
