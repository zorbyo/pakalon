...
description: >-
  Analyze raw prompts, identify intent and gaps, match Pakalon components
...
Analyze a draft prompt, critique it, match it to Pakalon ecosystem components,
...
- User says "what's the best way to ask Pakalon to..."
- User says "优化prompt", "改进prompt", "怎么写prompt", "帮我优化这个指令"
- User pastes a draft prompt and asks for feedback or enhancement
- User says "I don't know how to prompt for this"
- User says "how should I use Pakalon for..."
...
- User is asking about Pakalon configuration (use `configure-Pakalon` instead)
...
1. Check if a `Pakalon.md` exists in the working directory — read it for project conventions
...
### Phase 3: Pakalon Component Matching

Map intent + scope + tech stack (from Phase 0) to specific Pakalon components.
...
### Section 2: Recommended Pakalon Components
...
A compact version for experienced Pakalon users. Vary by intent type:
...
- "Optimize this prompt for Pakalon"
- "Rewrite this prompt so Pakalon uses the right commands"
- "帮我优化这个指令"
- "How should I prompt Pakalon for this task?"
...
|-----------|------------------|
| `configure-Pakalon` | User hasn't set up Pakalon yet |
